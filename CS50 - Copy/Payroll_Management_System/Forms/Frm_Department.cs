...
namespace Payroll_Management_System.Forms
{
    ...
    {
        private Payroll_Management_System.Models.Department _record;
        private Payroll_Management_System.Models.Department _oldRecord;
        public Dictionary<string, object> FixedValues = new Dictionary<string, object>();

        public Func<Payroll_Management_System.Models.Department, Payroll_Management_System.Models.Department, bool> BeforeSave { get; set; } = null;
        public Action<Payroll_Management_System.Models.Department> AfterSave { get; set; } = null;

        public Frm_Department(Payroll_Management_System.Models.Department record = null, bool readOnly = false)
        {
            ...
            if (record == null)
                _record = new Payroll_Management_System.Models.Department(); //create new recoded
            else
        ...
        private void Frm_Load(object sender, EventArgs e)
        {
            ...
            if (this.FixedValues.Count() > 0)
            {
                ...
                _record = tmp.ToObject<Payroll_Management_System.Models.Department>();
            }
