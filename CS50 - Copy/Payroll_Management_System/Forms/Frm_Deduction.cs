...
namespace Payroll_Management_System.Forms
{
    ...
    public partial class Frm_Deduction : Form
    {
        private Payroll_Management_System.Models.Deduction _record;
        private Payroll_Management_System.Models.Deduction _oldRecord;
        public Dictionary<string, object> FixedValues = new Dictionary<string, object>();

        public Func<Payroll_Management_System.Models.Deduction, Payroll_Management_System.Models.Deduction, bool> BeforeSave { get; set; } = null;
        public Action<Payroll_Management_System.Models.Deduction> AfterSave { get; set; } = null;

        public Frm_Deduction(Payroll_Management_System.Models.Deduction record = null, bool readOnly = false)
        {
            ...
            if (record == null)
                _record = new Payroll_Management_System.Models.Deduction(); //create new recoded
            else
        ...
        private void Frm_Load(object sender, EventArgs e)
        {
            ...
            if (this.FixedValues.Count() > 0)
            {
                ...
                _record = tmp.ToObject<Payroll_Management_System.Models.Deduction>();
            }
