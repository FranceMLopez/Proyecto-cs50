...
namespace Payroll_Management_System.Forms
{
    ...
    public partial class Frm_Allowance : Form
    {
        private Payroll_Management_System.Models.Allowance _record;
        private Payroll_Management_System.Models.Allowance _oldRecord;
        public Dictionary<string, object> FixedValues = new Dictionary<string, object>();

        public Func<Payroll_Management_System.Models.Allowance, Payroll_Management_System.Models.Allowance, bool> BeforeSave { get; set; } = null;
        public Action<Payroll_Management_System.Models.Allowance> AfterSave { get; set; } = null;

        public Frm_Allowance(Payroll_Management_System.Models.Allowance record = null, bool readOnly = false)
        {
            ...
            if (record == null)
                _record = new Payroll_Management_System.Models.Allowance(); //create new recoded
            else
        ...
        private void Frm_Load(object sender, EventArgs e)
        {
            ...
            if (this.FixedValues.Count() > 0)
            {
                ...
                _record = tmp.ToObject<Payroll_Management_System.Models.Allowance>();
            }
